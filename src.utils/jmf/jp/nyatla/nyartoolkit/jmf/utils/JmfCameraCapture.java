...
public class JmfCameraCapture
{
    ...
    public JmfCameraCapture(int i_width, int i_height, float i_rate,
	    String i_pixcel_format) {
	String encoding = i_pixcel_format;// comboEncoding.getSelectedItem();
	image_size = new Dimension(i_width, i_height);
	jmf_video_format = new VideoFormat(encoding, image_size,
		Format.NOT_SPECIFIED, null, i_rate);
    }
	...
	jmf_monitor_stream = (MonitorStream) ds
