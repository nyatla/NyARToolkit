...
public class NyARQrCodeSymbolBinder
{
	...
	private void bindSquare(NyARSquare i_sq1,int i_lv1,NyARSquare i_sq2,int i_lv2,NyARSquare o_qr_square)
	{
		...
		for (int i = 0; i < 4; i++) {
			...
			final double w1 = l_line_2.a * l_line_i.b - l_line_i.a * l_line_2.b;
			if (w1 == 0.0) {
				return;
			}
			l_sqvertex[i].x = (l_line_2.b * l_line_i.c - l_line_i.b * l_line_2.c) / w1;
			l_sqvertex[i].y = (l_line_i.a * l_line_2.c - l_line_2.a * l_line_i.c) / w1;
