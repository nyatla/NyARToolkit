...
import jp.nyatla.nyartoolkit.core2.types.matrix.NyARFixedFloat16Matrix33;
...
public class NyARFixedFloatRotVector
{
	...
	public NyARFixedFloatRotVector(NyARPerspectiveProjectionMatrix i_cmat) throws NyARException
	{
		...
		//FixedFloat16にコピー
		this._cmat.m00=(long)(i_cmat.m00*0x10000);
		this._cmat.m01=(long)(i_cmat.m01*0x10000);
		this._cmat.m02=(long)(i_cmat.m02*0x10000);
		this._cmat.m10=(long)(i_cmat.m10*0x10000);
		this._cmat.m11=(long)(i_cmat.m11*0x10000);
		this._cmat.m12=(long)(i_cmat.m12*0x10000);
		this._cmat.m20=(long)(i_cmat.m20*0x10000);
		this._cmat.m21=(long)(i_cmat.m21*0x10000);
		this._cmat.m22=(long)(i_cmat.m22*0x10000);
