...
public class NyARSurfaceDataSet
{
	...
	protected NyARSurfaceDataSet(NyARSurfaceImageSet i_iset,NyARSurfaceFeatureSet i_fset) throws NyARException
	{
		this.iset=i_iset;
		this.fset=i_fset;
	}
	public static NyARSurfaceDataSet loadFromSurfaceFiles(InputStream i_iset_stream,InputStream i_fset_stream) throws NyARException
	{
