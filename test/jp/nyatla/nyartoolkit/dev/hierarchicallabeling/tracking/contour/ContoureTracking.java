...
public class ContoureTracking
{
	private class DistMap extends NyARDistMap
	{
		...
		public void setPointDists(ContoureTargetList.ContoureTargetItem[] i_vertex_r,int i_row_len,ContoureTargetSrc.ContoureTargetSrcItem[] i_vertex_c,int i_col_len)
		{
	...
	public ContoureTracking(int i_size)
	{
	 ...
	 * @param i_target
	 */
	public void updateTrackTargetBySrc(long i_tick,ContoureTargetSrc i_src,ContoureTargetList i_target)
	{
		//tick限界の計算
