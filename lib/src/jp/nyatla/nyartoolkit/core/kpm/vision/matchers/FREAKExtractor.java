...
public class FREAKExtractor
{
    ...
    final private static float[] freak84_points_ring0 ={
        0.000000f, 0.362783f,
        -0.314179f, 0.181391f,
        -0.314179f, -0.181391f,
        -0.000000f, -0.362783f,
    ...
    final private static float[] freak84_points_ring1 ={
        -0.595502f, 0.000000f,
        -0.297751f, -0.515720f,
        0.297751f, -0.515720f,
        0.595502f, -0.000000f,
    ...
    final private static float[] freak84_points_ring2 ={
        -0.000000f, -0.741094f,
        0.641806f, -0.370547f,
        0.641806f, 0.370547f,
        0.000000f, 0.741094f,
    ...
    final private static float[] freak84_points_ring3 ={
        0.847306f, -0.000000f,
        0.423653f, 0.733789f,
        -0.423653f, 0.733789f,
        -0.847306f, 0.000000f,
    ...
    final private static float[] freak84_points_ring4 ={
        0.000000f, 0.930969f,
        -0.806243f, 0.465485f,
        -0.806243f, -0.465485f,
        -0.000000f, -0.930969f,
    ...
    final private static float[] freak84_points_ring5 = {
        -1.000000f, 0.000000f,
        -0.500000f, -0.866025f,
        0.500000f, -0.866025f,
        1.000000f, -0.000000f,
...
//            ASSERT(num_points == points.size(), "Should be same size");
         ...
         boolean SamplePyramidFREAK84(float[] samples,
             ...
             samples[5] = SampleReceptor(pyramid, r5[10], r5[11], lr.octave, lr.scale);
             ...
             samples[11] = SampleReceptor(pyramid, r4[10], r4[11], lr.octave, lr.scale);
             ...
             samples[17] = SampleReceptor(pyramid, r3[10], r3[11], lr.octave, lr.scale);
             ...
             samples[23] = SampleReceptor(pyramid, r2[10], r2[11], lr.octave,lr.scale);
             ...
             samples[35] = SampleReceptor(pyramid, r0[10], r0[11], lr.octave, lr.scale);
         ...
         void CompareFREAK84(int[] desc, float[] samples) {
             ...
             for(int i = 0; i < 37; i++) {
                 for(int j = i+1; j < 37; j++) {
                     bitstring_set_bit(desc, pos, (samples[i] < samples[j])?1:0);
                     pos++;
                 }
             }
...
//    
     ...
     */
    private float SampleReceptor(GaussianScaleSpacePyramid pyramid,
                                float x,
                                float y,
                                int octave,
                                int scale)
     ...
     * Sample a receptor given (x,y) given an image.
     */
    private float SampleReceptor(KpmImage image,
                                float x,
                                float y) {
        return SampleReceptorBilinear(image, x, y);
    }
     ...
     * Sample a receptor given (x,y) given an image using bilinear interpolation.
     */
    private float SampleReceptorBilinear(KpmImage image,
                                float x,
                                float y) {
