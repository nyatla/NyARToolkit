...
{
    public NyARRasterReader_RgbMul_BYTE_C8C8C8(INyARRaster i_raster) throws NyARException
    {
...
{
    public NyARRasterReader_RgbMul_BYTE_C8C8C8X8(INyARRaster i_raster) throws NyARException
    {
	this._raster=i_raster;
	this._size=i_raster.getSize();
    }
...
{
    public NyARRasterReader_RgbMul_NULL_ALLZERO(INyARRaster i_raster) throws NyARException
    {
	this._size=i_raster.getSize();
    }
    public void readRow(int i_row,int[] o_line)
