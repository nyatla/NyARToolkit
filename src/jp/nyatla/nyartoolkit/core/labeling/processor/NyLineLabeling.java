...
/**
 * 1ラインづつラベリングするラベリングプロセッサです。
 * 左上(1,1)を基点に、左と上のピクセルを優先して結合したラベリングを行います。
 *
 */
public class NyLineLabeling implements INyARLabeling
{
    ...
    public void labeling(INyARRasterReader i_input_raster) throws NyARException
    {
	int x,y;
	...
	for(y=1;y<lysize;y++){
	    ...
	    out_line1=label_img[y-1];	    
            for(x=1;x<lxsize;x++){
        	/*
        	if(in_line[x]<thmap.getThreshold(x,y)){
        	    out_line0[x]=0;
        	    continue;
        	}*/
