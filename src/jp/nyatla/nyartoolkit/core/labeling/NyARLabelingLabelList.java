...
{    
     ...
     * @param i_holder_size
     */
    public NyARLabelingLabelList()
    {
	//ポインタだけははじめに確保しておく
	this._labels=new NyARLabelingLabel[ARRAY_MAX];
	//現在アロケート中の個数は0
	...
	{
	    this._labels[i]=new NyARLabelingLabel();
	}
	this._allocated_size=range;
    }
    public final NyARLabelingLabel[] getArray()
    {
	return this._labels;
    }
    /**
