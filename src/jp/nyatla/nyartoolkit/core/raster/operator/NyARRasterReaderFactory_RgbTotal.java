 ...
 */
 ...
 {
     public NyARRasterReader_RgbTotal_BYTE_C8C8C8(NyARRaster i_raster) throws NyARException
     {
 ...
 {
     public NyARRasterReader_RgbTotal_BYTE_C8C8C8X8(NyARRaster i_raster) throws NyARException
     {
	 this._raster=i_raster;
	 this._size=i_raster.getSize();
     }
 ...
 {
     public NyARRasterReader_RgbTotal_NULL_ALLZERO(NyARRaster i_raster) throws NyARException
     {
	 this._size=i_raster.getSize();
     }
     public void readRow(int i_row,int[] o_line)
